:PROPERTIES:
:ID:       a7514bf6-07b6-45ab-9838-db50dcc75526
:END:
#+title:    Main configuration
#+subtitle: ;;; $DOOMDIR/config.el -*- lexical-binding: t; -*-
...
** Corfu tailwind completions fix
- Emacs considers '-' to be punctuation, and corfu treated it as a separator
- That broke tailwind's completions as they rely heavily on '-'
- This fix removes the quit boundary (default = separator) whenever tsx-ts-mode is on
#+begin_src emacs-lisp
(after! corfu
...
** Temporary projectile fix until doom introduces a fix
#+begin_src emacs-lisp
(after! projectile
